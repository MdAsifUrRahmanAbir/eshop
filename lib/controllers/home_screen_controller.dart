...
import 'package:final_project/models/SixamMart/popular/PopularModel.dart';
import 'package:final_project/models/SixamMart/popular/Products.dart';
...
class HomeScreenController extends GetxController{
  ...
  RxObjectMixin<PopularModel> myPopularData=PopularModel().obs;
  ...
  //       EasyLoading.show(status: 'loading...');
  //
  //       var response=await dio.get(Apis.getPopularItem);
  //
  //       if(response.statusCode==200){
  //         print('POPULAR DATA =====> loaded data RESPONSE Code:::  ${response.statusCode}:: ${response.statusMessage}');
  //         print('${response.data}');
  //
  //         var myReceivedData=response.data;
  //         print('POPULAR DATA =====> Recive Data::: $myReceivedData');
  //
  //
  //         myPopularData.value=PopularModel.fromJson(myReceivedData);
  //         print('POPULAR DATA =====> loaded data To Model Popular');
  //         isLoading.value=false;
  //
  //       }else{
  //         print('POPULAR DATA =====>Failed to load data');
  //       }
  //     }
  //   }catch(e){
  //     print('Error occurred: $e');
  ...
  //         var myReceivedData=response.data as List;
  //
  //         productList.value=myReceivedData.map((e) => Products.fromJson(e)).toList();
  //         isLoading.value=false;
  //         print('ProductList is working:  ${productList.length}');
  //         print('ProductList is working:  ${productList[0].name}');
  //
  //       }else{
  //         print('Failed to load data');
  //       }
...
void getEshopCategories() async{
  ...
  Dio  dio=Dio(BaseOptions(
    baseUrl:'https://foodbukka.herokuapp.com',
  ));
  ...
  try{
    ...
    if (connectivityResult == ConnectivityResult.none) {
      ...
      var response=await dio.post('/api/v1/restaurant');
